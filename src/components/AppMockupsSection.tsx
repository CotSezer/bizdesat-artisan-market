        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          animationDelay: `${index * 200}ms`
              ...
              <div className="w-full h-64 bg-gradient-to-br from-[#0046C6]/10 to-[#FFD700]/20 rounded-xl mb-4 flex items-center justify-center relative overflow-hidden">
                {mockup.type === "homepage" ? <img src="/lovable-uploads/9b82b652-3a02-4a40-9596-e59104a555ab.png" alt="Ana Sayfa Görünümü" className="w-full h-full object-cover rounded-xl" /> : mockup.type === "listing" ? <img src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80" alt="Ürün Listesi Görünümü" className="w-full h-full rounded-xl object-cover" /> : <img src="https://images.unsplash.com/photo-1487958449943-2429e8be8625?auto=format&fit=crop&w=800&q=80" alt="Kategori Görünümü" className="w-full h-full object-cover rounded-xl" />}
              </div>
